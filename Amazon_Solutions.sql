...
-- Finding the distinct payment status in payments column
SELECT DISTINCT (payment_status) FROM payments


-- finding the return date as the initial few data had shown null values for return date.
SELECT * FROM shipping
...
SELECT t2.category_id,t1.category_name,SUM(total_sale) as Total_Revenue,SUM(total_sale)/(SELECT SUM(total_sale) FROM order_items) *100 as percentage_contribution
FROM category t1
INNER JOIN products t2
ON t1.category_id=t2.category_id
INNER JOIN order_items t3
ON t2.product_id=t3.product_id
GROUP BY t1.category_name,t2.category_id
